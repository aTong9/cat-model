...
test('cosmic replacement is strictly scoped to token 3000',()=>{assert.equal(shouldUseCosmicWorld3000(3000,'Galactic Voyage'),true);assert.equal(shouldUseCosmicWorld3000('3000','Galactic Voyage'),true);assert.equal(shouldUseCosmicWorld3000(3001,'Galactic Voyage'),false);assert.equal(shouldUseCosmicWorld3000(3000,'Time Traveler'),false)})
