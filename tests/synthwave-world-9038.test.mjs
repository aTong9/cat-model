...
test('synthwave replacement is strictly scoped to token 9038',()=>{assert.equal(shouldUseSynthwaveWorld9038(9038,'Time Traveler'),true);assert.equal(shouldUseSynthwaveWorld9038('9038','Time Traveler'),true);assert.equal(shouldUseSynthwaveWorld9038(9039,'Time Traveler'),false);assert.equal(shouldUseSynthwaveWorld9038(9038,'Fitness Guru'),false)})
