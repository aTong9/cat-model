...
export function createSdfCatBody(furColor = '#f4c430', opts = {}) {
  ...
  const prims = [
    ...
    // 左耳
    roundCone({
      a: { x: -0.17 * wid, y: 1.28, z: -0.06 },
      b: { x: -0.20 * wid, y: 1.56, z: -0.10 },
      r1: 0.085 * hr, r2: 0.012,
      k: 0.16, tag: 'ear',
    }),
    ...
    // 左臂 —— 自然下垂
    roundCone({
      a: { x: -0.30, y: 0.72, z: 0.03 },
      b: { x: -0.36, y: 0.44, z: 0.07 },
      r1: 0.068, r2: 0.058,
      k: 0.14, tag: 'arm',
    }),
    roundCone({
      a: { x: -0.36, y: 0.44, z: 0.07 },
      b: { x: -0.33, y: 0.20, z: 0.09 },
      r1: 0.058, r2: 0.048,
      k: 0.12, tag: 'arm',
    }),
    // 左爪
    sphere({
      c: { x: -0.33, y: 0.17, z: 0.10 },
      r: 0.052,
      s: [1.15, 0.70, 0.70],
      k: 0.12, tag: 'arm',
    }),
