...
const stateLabel = computed(() => imageState.value === 'ready'
  ? (usingFallback.value || ['local', 'preview'].includes(store.referenceImageSource) ? t('comparison.local') : t('comparison.remote'))
