...
<style scoped>
.view-controls{position:fixed;z-index:100;left:50%;top:14px;display:flex;align-items:center;gap:3px;padding:5px;transform:translateX(-50%);border-radius:11px}.view-controls span{padding:0 7px;color:#778198;font-size:.61rem}.view-controls button{min-height:30px;padding:0 9px;border:0;border-radius:7px;background:transparent;color:#abb2c5;font-size:.66rem;cursor:pointer}.view-controls button:hover{background:rgba(255,255,255,.07)}.view-controls button.active{background:rgba(245,211,61,.16);color:var(--accent)}@media(max-width:900px){.view-controls{top:58px}.view-controls span{display:none}.view-controls button{min-height:34px;padding-inline:10px}}@media(max-width:600px){.view-controls{top:60px;width:calc(100% - 20px);justify-content:center}.view-controls button{flex:1;padding-inline:4px}}
</style>
