export const OUTPUT_PROFILES = Object.freeze({
  ...
  turnaround: Object.freeze({ views: ['front', 'side', 'back'], width: 3072, height: 1024, alpha: true }),
})
...
export function auditCharacterQuality(root, { maxTriangles = 250000, maxMaterials = 80 } = {}) {
  let triangles = 0
  ...
  return Object.freeze({ valid: errors.length === 0, errors, triangles: Math.ceil(triangles), materials: materials.size })
}
